...
public class Database {
	...
	public ArrayList<Tabela> lerTabelasBanco(HashMap<String, String> tabelasLabel, HashMap<String, ArrayList<String>> colunasSelecionadas, Conectar conexao){
		...
		for (String chave: tabelasLabel.keySet()){
			...
			resultado.add(ex.getTabela(conexao, chave, selecionar, tabelasLabel.get(chave)));
		}
		return resultado;
	}
